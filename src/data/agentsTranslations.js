...
export const AGENT_DESCRIPTIONS_I18N = {
    'sales-qualification': {
        ...
        sv: "Undersöker inkommande leads autonomt, bedömer dem mot din målkundsprofil, skriver personliga kontaktmejl och — i läget Undersök-och-engagera — engagerar prospekt, tillämpar BANT-kriterierna och överlämnar kvalificerade leads till säljarna."
    },
    'sales-research': {
        ...
        sv: "Hjälper säljare att lösa komplexa affärsfrågor via en dialog på naturligt språk med sina försäljningsdata och lyfter fram insikter och researchplaner som går att agera på direkt."
    },
    'sales-close': {
        ...
        sv: "Utformad för försäljning med hög hastighet och automatiserar hela försäljningscykeln — engagerar kunder proaktivt och rekommenderar produkter via anpassningsbara playbooks för att påskynda avslut."
    },
    'case-management': {
        ...
        sv: "Automatiserar hela ärendets livscykel — skapande, fältprediktion, uppdatering och lösning — autonomt över chatt-, e-post- och röstkanaler."
    },
    'intent-knowledge': {
        ...
        sv: "Två kompletterande agenter som sluter cirkeln för kundförståelse. Customer Intent kartlägger kundbehov utifrån tidigare och pågående konversationer för att styra dirigering och vägledning; Customer Knowledge Management omvandlar varje löst ärende till regelefterlevande artikelutkast och håller kunskapsbasen aktuell."
    },
    'quality-evaluation': {
        ...
        sv: "Utför autonoma, AI-stödda utvärderingar av interaktioner mellan agent och kund utifrån ramverk som definierats av handledare, och skalar därmed kvalitetssäkringen över ärenden och konversationer."
    },
    'scheduling-operations': {
        ...
        sv: "Optimerar dynamiskt en enskild teknikers schema, respekterar låsta bokningar och arbetstider och flyttar icke-bundet arbete för att maximera beläggningen eller prioritera brådskande förfrågningar."
    },
    'account-reconciliation': {
        ...
        sv: "Stämmer av reskontror (leverantörsreskontra, kundreskontra, skatt, bank) mot huvudboken i nära realtid, rekommenderar åtgärder för undantag som avvikande verifikationsbelopp och behåller en fullständig granskningslogg för varje korrigering."
    },
    'supplier-communications': {
        ...
        sv: "Skriver och skickar uppföljningar av inköpsorder, läser sedan leverantörers e-postsvar för att upptäcka ändringar i kvantitet, pris, annullering och leveransdatum — som lämnas till inköparen för granskning."
    },
    'time-and-expense-agent': {
        ...
        sv: "Förenar registreringen av projektkostnader genom två flöden. Time Entry skriver veckovisa poster utifrån tilldelningar, bokningar och Outlook-kontext; Expense läser in kvitton från inkorgen, mobilappen eller direktuppladdning för att kategorisera, specificera och gruppera dem i utläggsrapporter per resa eller projekt."
    },
    'sales-order-agent': {
        ...
        sv: "Bevakar en konfigurerad inkorg, identifierar kunden, tolkar inkommande offert- och orderförfrågningar, kontrollerar artikeltillgänglighet och skriver motsvarande offert eller order i Business Central."
    },
    'payables-agent': {
        ...
        sv: "Bevakar en leverantörsinkorg efter faktura-PDF:er, extraherar data via OCR, stämmer av rader mot inköpsorder och inleveranser och skriver inköpsfakturor för mänskligt godkännande."
    }
};
...
export const EXTRA_I18N = {
    'd365-mcp-servers': {
        ...
        sv: {
            name: "Stärk Supply Chain och Finance med Dynamics 365 MCP-servrar",
            description: "Dynamics 365 ERP MCP-servern exponerar data och affärslogik från Finance and Operations för varje Model Context Protocol-kompatibel agent — Microsoft Copilot Studio, Microsoft Foundry, GitHub Copilot och agentplattformar från tredje part — utan anpassade kopplingar eller API:er. En kompletterande ERP Analytics MCP-server gör Business Performance Analytics-dataset (Record-to-Report, Procure-to-Pay, Order-to-Cash) frågbara på naturligt språk. Tillsammans gör de att agenter kan generera insikter och utlösa transaktionsåtgärder över Finance, Supply Chain Management och Project Operations via ett enda, styrt protokoll."
        }
    }
};
...
export const CHAPTER_I18N = {
    170: {
        ...
        sv: { title: "AI-agenter för säljare", desc: "Introduktion av AI-agenter som tar över tidskrävande administrativa uppgifter och ger säljarna tid att bygga relationer." }
    },
    217: {
        ...
        sv: { title: "Sales Development Agent", desc: "Undersöker automatiskt nya leads (t.ex. eventdeltagare), kontaktar dem proaktivt, kvalificerar dem och överlämnar dem sömlöst till säljteamet så snart de är redo för ett möte." }
    },
    253: {
        ...
        sv: { title: "Sales Close Agent", desc: "Automatiserad assistent som undersöker konton, identifierar viktiga intressenter, lyfter fram potentiella risker och föreslår relevanta samtalsämnen för att hjälpa till att sluta affärer." }
    },
    526: {
        ...
        sv: { title: "Konversationsbaserade pipelineinsikter", desc: "Sales Operations Managers kan på naturligt språk ställa frågor om pipelinens hälsa, konverteringstrender och framväxande risker utan att behöva ta fram komplexa rapporter." }
    },
    636: {
        ...
        sv: { title: "Proaktiv kundtjänst", desc: "Gå från reaktiv support till proaktivt engagemang och låt systemet förutse kundernas behov och ta första steget." }
    },
    700: {
        ...
        sv: { title: "Operativa insikter för handledare", desc: "AI-agenter upptäcker framväxande risker tidigt — obalans i arbetsbelastning, felkonfigurationer, kompetensglapp — och föreslår åtgärder som att justera bemanningen." }
    },
    815: {
        ...
        sv: { title: "AI-agent för proaktivt engagemang", desc: "Upptäcker omedelbart kundens avsikt utifrån meddelandena och ger direkta, korrekta svar (t.ex. förtydligande av försäkringsskydd) utan mänsklig inblandning." }
    },
    866: {
        ...
        sv: { title: "Case Management Agent", desc: "När ett ärende eskaleras till en mänsklig handläggare har den här agenten redan skapat ärendet och fångat de viktigaste detaljerna, så att handläggaren direkt har full kontext." }
    },
    881: {
        ...
        sv: { title: "Customer Intent Agent", desc: "Lyfter fram relevant policyinformation, föreslagna nästa steg och extern kunskap via Copilot Studio för att hjälpa liveagenter att svara med självförtroende." }
    },
    932: {
        ...
        sv: { title: "Quality Evaluation Agent", desc: "Konsoliderar teamets prestationsvyer för handledare och genererar automatiskt utvärderingar ärende för ärende med kvalitetspoäng och motivering." }
    },
    1199: {
        ...
        sv: { title: "Agentbaserad ERP och efterfrågeplanering", desc: "Kombinerar historisk försäljningsprestanda med marknadsinsikter för mycket exakta, framåtblickande efterfrågeprognoser, särskilt vid säsongsväxlingar." }
    },
    1277: {
        ...
        sv: { title: "Intelligent lagerbalansering", desc: "Använder AI-drivna prognoser för att skapa lagerarbetsorder som flyttar specifika artiklar till optimala plockplatser innan en efterfrågetopp." }
    },
    1306: {
        ...
        sv: { title: "Avancerad optimering av plockrutter", desc: "Grupperar och sekvenserar order intelligent för att minimera gångtid och trängsel i mycket stora lager." }
    },
    1355: {
        ...
        sv: { title: "B2B-handel för flera försäljningsställen", desc: "Enhetlig inköpsupplevelse där köpare kan visa och beställa för flera auktoriserade platser via en enda inloggning." }
    },
    1392: {
        ...
        sv: { title: "Integration av Commerce MCP-servern", desc: "Driftsätter anpassade intelligenta agenter direkt i Microsoft Teams för att hjälpa callcentermedarbetare att snabbt lägga regelefterlevande order med fullständig kontokontext." }
    },
    1461: {
        ...
        sv: { title: "Enhetligt ramverk för e-fakturaintegration", desc: "Genererar och dirigerar automatiskt e-fakturor mellan olika länder utan komplexa anpassade integrationer och säkerställer efterlevnad av lokala regler." }
    },
    1522: {
        ...
        sv: { title: "AI-driven fakturahantering", desc: "Automatiserar inläsning och matchning av leverantörsfakturor mot inköpsorder och ökar andelen beröringsfri hantering." }
    },
    1563: {
        ...
        sv: { title: "Account Reconciliation Agent", desc: "Stämmer automatiskt av lagerrörelser mot den finansiella bokföringen och lyfter endast fram de verkliga undantag som kräver mänsklig uppmärksamhet." }
    },
    1668: {
        ...
        sv: { title: "LinkedIn HR-integration", desc: "Låter team för talangförvärv publicera jobbannonser direkt på plattformar som LinkedIn och hantera rekryteringsflöden sömlöst." }
    },
    1677: {
        ...
        sv: { title: "Onboarding Agent", desc: "Inbäddad i Microsoft Teams automatiserar denna agent dokumentinsamling och rollspecifika utbildningssteg för att snabbt få nyanställda produktiva." }
    },
    1811: {
        ...
        sv: { title: "Bokning av flera resurser (Project Operations)", desc: "Resurschefer kan välja och bekräfta flera specialister samtidigt från schematavlan, vilket avsevärt påskyndar projektbemanningen." }
    },
    1846: {
        ...
        sv: { title: "Automatiserade prisändringar", desc: "Tillämpar automatiskt strategiska prisuppdateringar och justeringar av tjänstepaket utifrån ikraftträdandedatum och säkerställer pris noggrannhet i kundavtal." }
    },
    1875: {
        ...
        sv: { title: "Tidslinjevy för bemanning", desc: "Tydlig visuell indikator för schemalagt arbete kontra bench-tid, som hjälper ledare att effektivt minska beläggningens volatilitet." }
    },
    1931: {
        ...
        sv: { title: "Säker byråportal", desc: "Ersätter manuella överlämningar och gäståtkomst genom att integrera externa rekryteringsbyråer direkt i företagets arbetsflöden med rollbaserad åtkomst." }
    },
    1988: {
        ...
        sv: { title: "Mobil anteckningskontroll (Field Service)", desc: "Låter fälttekniker enkelt fånga text, bilder och video på tidslinjen utan att avbryta sitt arbetsflöde." }
    },
    2008: {
        ...
        sv: { title: "Scheduling Operations Agent", desc: "Startar ad hoc-optimeringsplaner och möjliggör schemajusteringar direkt från tavlan, för fältservicemiljöer med många begränsningar." }
    }
};
