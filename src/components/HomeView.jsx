                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div className="flex-1 text-center md:text-start">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full text-xs font-bold uppercase tracking-wider mb-4 border border-white/10 text-blue-200">
                            <Blocks size={14} /> Core Foundation
                        </div>
                ...
                {mappedPortfolio.map((cat) => {
                    ...
                    return (
                        <div
                            ...
                            className={`group relative bg-white rounded-3xl p-6 border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden transform hover:-translate-y-1 flex flex-col h-full`}
                        >
                            ...
                            <h3 className="text-xl font-bold text-slate-900 mb-3 leading-tight relative z-10">{localeCat.name}</h3>
                            <p className="text-slate-600 leading-snug mb-6 text-sm font-medium flex-grow relative z-10">{localeCat.description}</p>
